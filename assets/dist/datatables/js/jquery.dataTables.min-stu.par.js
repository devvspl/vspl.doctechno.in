(function(h) {
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "No data available in table <br /> <br /><img src='http://scan.doctechno.in/assets/images/addnewitem.svg' width='150'><br /><br /> <span class='text-success bolds'><i class='fa fa-arrow-left'></i> Search with different criteria.</span>",
            sInfo: "Records: _START_ to _END_ of _TOTAL_",
            sInfoEmpty: "Records: 0 to 0 of 0",
    ...
    h.extend(Kb, {
        simple: function() {
            return ["<i class='fa fa-angle-right'></i>", "<i class='fa fa-angle-left'></i>"]
        },
        full: function() {
