...
class Punch extends CI_Controller
{
    ...
    public function get_additional_information_by_scan_id($scan_id)
    {
        ...
        $this->db->select(
            "aii.*, cc.name, d.department_name, bu.business_unit_name, r.region_name, s.state_name, l.city_village_name as location_name, c.category_name, cr.crop_name, a.activity_name, da.account_name as debit_account, pm.payment_term_name as payment_term"
        );
    ...
    private function getCommonPunchData($scan_id, $doc_type_id, $punch_table)
    {
        ...
        $docTypeViews = [
            ...
            1 => [
                "view" => "two_four_wheeler",
                "data_method" => "getTwoFourWheelerData",
            ],
            4 => [
                "view" => "bank_statement",
                "data_method" => "getBankStatementData",
            ],
            5 => [
                "view" => "boarding_pass",
                "data_method" => "getBoardingPassData",
            ],
            6 => [
                "view" => "cash_deposit_withdrawals",
                "data_method" => "getCashDepositWithdrawalsData",
            ],
            8 => [
                "view" => "certificate",
                "data_method" => "getCertificateData",
            ],
            10 => [
                "view" => "company_record",
                "data_method" => "getCompanyRecordData",
            ],
            11 => [
                "view" => "confirmation_account",
                "data_method" => "getConfirmationAccountData",
            ],
            18 => [
                "view" => "id_address_proof",
                "data_method" => "getIdAddressProofData",
            ],
            19 => [
                "view" => "import_export_paper",
                "data_method" => "getImportExportPaperData",
            ],
            30 => [
                "view" => "mediclaim_history",
                "data_method" => "getMediclaimHistoryData",
            ],
            31 => [
                "view" => "miscellaneous",
                "data_method" => "getMiscellaneousData",
            ],
            32 => ["view" => "pf_esic", "data_method" => "getPfEsicData"],
            35 => [
                "view" => "property_record",
                "data_method" => "getPropertyRecordData",
            ],
            36 => [
                "view" => "reting_credential",
                "data_method" => "getRetingCredentialData",
            ],
            37 => [
                "view" => "registration_certificate",
                "data_method" => "getRegistrationCertificateData",
            ],
            41 => [
                "view" => "tax_credit_document",
                "data_method" => "getTaxCreditDocumentData",
            ],
            45 => [
                "view" => "vehicle_registration_paper",
                "data_method" => "getVehicleRegistrationPaperData",
            ],
            44 => [
                "view" => "vehicle_maintenance",
                "data_method" => "getVehicleMaintenanceData",
            ],
            43 => [
                "view" => "vehicle_fule",
                "data_method" => "getVehicleFuelData",
            ],
            42 => [
                "view" => "telephone_bill",
                "data_method" => "getTelephoneBillData",
            ],
            ...
            34 => [
                "view" => "postage_courier",
                "data_method" => "getPostageCourierData",
            ],
            ...
            27 => [
                "view" => "local_conveyance",
                "data_method" => "getLocalConveyanceData",
            ],
            26 => ["view" => "lease_rent", "data_method" => "getLeaseRentData"],
            25 => [
                "view" => "jeep_campaign",
                "data_method" => "getJeepCampaignData",
            ],
            24 => ["view" => "it_return", "data_method" => "getItReturnData"],
            22 => [
                "view" => "insurance_policy",
                "data_method" => "getInsurancePolicyData",
            ],
            21 => [
                "view" => "insurance_document",
                "data_method" => "getInsuranceDocumentData",
            ],
            20 => [
                "view" => "income_taxt_tds",
                "data_method" => "getIncomeTaxTdsData",
            ],
            17 => [
                "view" => "hired_vehicle",
                "data_method" => "getHiredVehicleData",
            ],
            16 => ["view" => "challan", "data_method" => "getChallanData"],
            15 => [
                "view" => "fixed_deposit_receipt",
                "data_method" => "getFixedDepositReceiptData",
            ],
            14 => ["view" => "fd_fv", "data_method" => "getFdFvData"],
            13 => [
                "view" => "electricity_bill",
                "data_method" => "getElectricityBillData",
            ],
            12 => [
                "view" => "dealer_meeting",
                "data_method" => "getDealerMeetingData",
            ],
            9 => ["view" => "cheque", "data_method" => "getChequeData"],
            7 => [
                "view" => "cash_voucher",
                "data_method" => "getCashVoucherData",
            ],
            46 => [
                "view" => "gst_challan",
                "data_method" => "getGstChallanData",
            ],
            47 => [
                "view" => "labour_payment",
                "data_method" => "getLabourPaymentData",
            ],
            48 => [
                "view" => "cash_receipt",
                "data_method" => "getCashReceiptData",
            ],
            49 => [
                "view" => "fixed_asset",
                "data_method" => "getFixedAssetData",
            ],
            50 => [
                "view" => "machine_operation",
                "data_method" => "getMachineOperationData",
            ],
            ...
            55 => [
                "view" => "ticket_cancellation",
                "data_method" => "getTicketCancellationData",
            ],
            56 => [
                "view" => "credit_note",
                "data_method" => "getCreditNoteData",
            ],
        ];
        return [
            "scan_id" => $scan_id,
            ...
            "doc_config" => $docTypeViews[$doc_type_id] ?? null,
        ];
    }
    ...
    private function getInvoiceData($scan_id, $doc_type_id, $punch_table)
    {
        return [
            ...
            "punch_detail" => $this->db->get_where($punch_table, ["scan_id" => $scan_id])->row(),
            ...
            "temp_punch_detail" => $this->db
                ->get_where("ext_tempdata_{$doc_type_id}", [
                    "scan_id" => $scan_id,
                ])
                ->row(),
            "document_number" =>
                ...
                str_pad(
                    $this->db
                        ...
                        ->count_all_results($punch_table) + 1,
                    4,
                    "0",
                    STR_PAD_LEFT
                ),
    ...
    public function finance_resend_scan($scan_id)
    {
        ...
        $result = $this->db->update("y{$this->year_id}_scan_file", [
            ...
            "Finance_Resend_By" => $user_id,
            "Finance_Resend_Remark" => $Reject_Remark,
            "finance_punch_action_status" => "P",
            "Finance_Resend_Date" => date("Y-m-d"),
        ]);
        if ($result) {
            echo json_encode([
                "status" => "200",
    ...
    public function savePunchToDatabase()
    {
        ...
        if ($is_update) {
            ...
            $this->db->where("FileID", $FileID)->update("sub_punchfile", [
                "Amount" => "-" . (float) ($this->input->post("Grand_Total") ?? 0),
                "Comment" => $this->db->escape_str($this->input->post("Remark") ?? ""),
            ]);
        } else {
    ...
    private function processPunchData_1($post)
    {
        ...
        $mainData = [
            ...
            "rs_km" => (float) ($post["Rate"] ?? 0),
            "total_run_km" => (float) ($post["Total_KM"] ?? 0),
            "location" => $this->db->escape_str($post["Location"] ?? ""),
            "round_off_type" => $this->db->escape_str($post["plus_minus"] ?? ""),
        ...
        for ($i = 0; $i < $count; $i++) {
            $items[] = [
                "scan_id" => $scan_id,
                "opening_km" => (float) ($post["Dist_Opening"][$i] ?? 0),
                "closing_km" => (float) ($post["Dist_Closing"][$i] ?? 0),
                "total_km" => (float) ($post["Km"][$i] ?? 0),
    ...
    private function processPunchData_6($post)
    {
        ...
        $mainData = [
            ...
            "doctype" => $DocType,
            "doctype_id" => $DocTypeId,
            "type" => $this->db->escape_str($post["Type"] ?? ""),
            "date" => $this->db->escape_str($post["Date"] ?? ""),
            "bank_name" => $this->db->escape_str($post["Bank_Name"] ?? ""),
            "branch" => $this->db->escape_str($post["Branch"] ?? ""),
            "account_no" => $this->db->escape_str($post["Account_No"] ?? ""),
            "beneficiary_name" => $this->db->escape_str($post["Beneficiary_Name"] ?? ""),
            "amount" => $this->db->escape_str($post["Amount"] ?? ""),
            "remark_comment" => $this->db->escape_str($post["Remark"] ?? ""),
            "created_by" => $this->session->userdata("user_id"),
            "created_at" => date("Y-m-d H:i:s"),
            "updated_at" => date("Y-m-d H:i:s"),
    ...
    private function processPunchData_17($post)
    {
        ...
        $mainData = [
            ...
            "per_km_rate" => (float) ($post["per_km_rate"] ?? 0.0),
            ...
            "other_charges" => (float) ($post["other_charges"] ?? 0.0),
            "total_amount" => (float) ($post["total_amount"] ?? 0.0),
    ...
    private function processPunchData_22($post)
    {
        ...
        $mainData = [
            ...
            "vehicle_no" => $this->db->escape_str($post["vehicle_no"] ?? ""),
            "location" => $this->db->escape_str($post["location"] ?? ""),
            "premium_amount" => (float) ($post["premium_amount"] ?? 0.0),
            "remark_comment" => $this->db->escape_str($post["remark_comment"] ?? ""),
            "created_by" => $this->session->userdata("user_id"),
            "created_at" => date("Y-m-d H:i:s"),
            "updated_at" => date("Y-m-d H:i:s"),
    ...
    private function processPunchData_27($post)
    {
        ...
        $mainData = [
            ...
            "per_km_rate" => (float) ($post["per_km_rate"] ?? 0.0),
            "total_km" => (float) ($post["total_km"] ?? 0.0),
            "total" => (float) ($post["total_amount"] ?? 0.0),
            "remark_comment" => $this->db->escape_str($post["remark_comment"] ?? ""),
            "created_by" => $this->session->userdata("user_id"),
            "created_at" => date("Y-m-d H:i:s"),
            "updated_at" => date("Y-m-d H:i:s"),
            ...
            foreach ($post["date"] as $key => $date) {
                if (!empty($date)) {
                    $items[] = [
                        ...
                        "opening_reading" => (float) ($post["dist_opening"][$key] ?? 0.0),
                        "closing_reading" => (float) ($post["dist_closing"][$key] ?? 0.0),
                        "total_km" => (float) ($post["km"][$key] ?? 0.0),
                        "amount" => (float) ($post["amount"][$key] ?? 0.0),
                    ];
                }
            }
        }
    ...
    private function processPunchData_28($post)
    {
        ...
        $mainData = [
            ...
            "rate" => (float) ($post["rate"] ?? 0.0),
            "amount" => (float) ($post["amount"] ?? 0.0),
            "other_charges" => (float) ($post["other_charges"] ?? 0.0),
            "discount" => (float) ($post["discount"] ?? 0.0),
            "gst" => (float) ($post["gst"] ?? 0.0),
            "grand_total" => (float) ($post["grand_total"] ?? 0.0),
            "remark_comment" => $this->db->escape_str($post["remark_comment"] ?? ""),
            "created_by" => $this->session->userdata("user_id"),
            "created_at" => date("Y-m-d H:i:s"),
            "updated_at" => date("Y-m-d H:i:s"),
    ...
    private function processPunchData_47($post)
    {
        ...
        $mainData = [
            ...
            "from_date" => $this->db->escape_str($post["from_date"] ?? ""),
            "to_date" => $this->db->escape_str($post["to_date"] ?? ""),
            "sub_total" => (float) ($post["sub_total"] ?? 0.0),
            "remark_comment" => $this->db->escape_str($post["remark_comment"] ?? ""),
            "created_by" => $this->session->userdata("user_id"),
            "created_at" => date("Y-m-d H:i:s"),
            "updated_at" => date("Y-m-d H:i:s"),
    ...
    private function processPunchData_51($post)
    {
        ...
        $mainData = [
            ...
            "base_fare" => (float) ($post["base_fare"] ?? 0.0),
            "gst" => (float) ($post["gst"] ?? 0.0),
            "fees_surcharge" => (float) ($post["fees_surcharge"] ?? 0.0),
            ...
            "total_fare" => (float) ($post["total_fare"] ?? 0.0),
            "remark_comment" => $this->db->escape_str($post["remark_comment"] ?? ""),
            "created_by" => $this->session->userdata("user_id"),
            "created_at" => date("Y-m-d H:i:s"),
            "updated_at" => date("Y-m-d H:i:s"),
    ...
    private function processPunchData_23($post)
    {
        ...
        $mainData = [
            "scan_id" => $scan_id,
            "group_id" => $this->session->userdata("group_id"),
            "doctype" => $this->db->escape_str($this->customlib->getDocType(23)),
            "doctype_id" => 23,
            "invoice_date" => $this->db->escape_str($post["Bill_Date"] ?? ""),
            "invoice_no" => $this->db->escape_str($post["Bill_No"] ?? ""),
            "mode_of_payment" => $this->db->escape_str($post["Payment_Mode"] ?? ""),
            "buyer" => $From,
            "vendor" => $To,
            "buyer_address" => $this->db->escape_str($post["Buyer_Address"] ?? ""),
            "vendor_address" => $this->db->escape_str($post["Vendor_Address"] ?? ""),
            "buyers_order_no" => $this->db->escape_str($post["Buyer_Order"] ?? ""),
            "buyers_order_date" => $this->db->escape_str($post["Buyer_Order_Date"] ?? ""),
            "dispatch_through" => $this->db->escape_str($post["Dispatch_Trough"] ?? ""),
            "delivery_note_date" => $this->db->escape_str($post["Delivery_Note_Date"] ?? ""),
            "voucher_type_category" => $this->db->escape_str($post["Category"] ?? ""),
            "lr_number" => $this->db->escape_str($post["LR_Number"] ?? ""),
            "lr_date" => $this->db->escape_str($post["LR_Date"] ?? ""),
            "cartoon_number" => $this->db->escape_str($post["Cartoon_Number"] ?? ""),
            "sub_total" => (float) ($post["Sub_Total"] ?? 0),
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            $invoiceDetails[] = [
                "scan_id" => $scan_id,
                "particular" => $this->db->escape_str($post["Particular"][$i] ?? ""),
                "hsn" => $this->db->escape_str($post["HSN"][$i] ?? ""),
                "qty" => (float) ($post["Qty"][$i] ?? 0),
                "unit" => $unit,
                "mrp" => (float) ($post["MRP"][$i] ?? 0),
                "discount_in_mrp" => (float) ($post["Discount"][$i] ?? 0),
                "price" => (float) ($post["Price"][$i] ?? 0),
                "amount" => (float) ($post["Amount"][$i] ?? 0),
                "gst" => (float) ($post["GST"][$i] ?? 0),
                "sgst" => (float) ($post["SGST"][$i] ?? 0),
                "igst" => (float) ($post["IGST"][$i] ?? 0),
                "cess" => (float) ($post["Cess"][$i] ?? 0),
    ...
    private function processPunchData_50($post)
    {
        ...
        $mainData = [
            ...
            "invoice_date" => $this->db->escape_str($post["invoice_date"] ?? ""),
            "particular" => $this->db->escape_str($post["particular"] ?? ""),
            "hour" => (float) ($post["hour"] ?? 0.0),
            "trips" => $this->db->escape_str($post["trips"] ?? ""),
            "rate_per_trip" => (float) ($post["rate_per_trip"] ?? 0.0),
            "total_amount" => (float) ($post["total_amount"] ?? 0.0),
            "remark_comment" => $this->db->escape_str($post["remark_comment"] ?? ""),
            "created_by" => $this->session->userdata("user_id"),
            "created_at" => date("Y-m-d H:i:s"),
    ...
    private function processPunchData_42($post)
    {
        ...
        $mainData = [
            ...
            "invoice_taxable_value" => (float) ($post["invoice_taxable_value"] ?? 0.0),
            "cgst" => (float) ($post["cgst"] ?? 0.0),
            "sgst" => (float) ($post["sgst"] ?? 0.0),
            "igst" => (float) ($post["igst"] ?? 0.0),
            "total_amount_due" => (float) ($post["total_amount_due"] ?? 0.0),
            "total_amount_outstanding" => (float) ($post["total_amount_outstanding"] ?? 0.0),
    ...
    private function processPunchData_43($post)
    {
        ...
        $mainData = [
            ...
            "liters" => (float) ($post["liters"] ?? 0.0),
            "per_liter_rate" => (float) ($post["per_liter_rate"] ?? 0.0),
            "amount" => (float) ($post["amount"] ?? 0.0),
            "round_off_value" => (float) ($post["round_off_value"] ?? 0.0),
    ...
    private function processPunchData_44($post)
    {
        ...
        $mainData = [
            ...
            "doctype_id" => 44,
            "invoice_date" => $this->db->escape_str($post["Bill_Date"] ?? ""),
            "invoice_no" => $this->db->escape_str($post["InvoiceNo"] ?? ""),
            "vehicle_no" => $this->db->escape_str($post["VehicleRegNo"] ?? ""),
            "vendor_name" => $From,
            "billing_to" => $To,
            "sub_total" => (float) ($post["Sub_Total"] ?? 0),
            "total" => (float) ($post["Total"] ?? 0),
    ...
    private function processPunchData_55($post)
    {
        ...
        $mainData = [
            ...
            "sub_total" => (float) ($post["sub_total"] ?? 0.0),
            "cancellation_charge" => (float) ($post["cancellation_charge"] ?? 0.0),
            "other_charges" => (float) ($post["other_charges"] ?? 0.0),
            "grand_total" => (float) ($post["grand_total"] ?? 0.0),
            "remark_comment" => $this->db->escape_str($post["remark_comment"] ?? ""),
            "created_by" => $this->session->userdata("user_id"),
    ...
    private function fetchPunchDetails($scan_id, $type_id, $year_id)
    {
        if ($scan_id <= 0 || $type_id <= 0) {
            echo json_encode([
                "status" => 400,
                "msg" => "Invalid scan_id or type_id",
            ]);
            return;
        }
        if (empty($year_id)) {
