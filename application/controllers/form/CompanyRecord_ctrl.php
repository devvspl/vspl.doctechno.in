...
class CompanyRecord_ctrl extends CI_Controller
{
    ...
    public function create()
    {
        ...
        if ($this->db->trans_status() === FALSE) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success text-left">Company Record added successfully</div>');
            redirect('punch');
        }
    }
}
