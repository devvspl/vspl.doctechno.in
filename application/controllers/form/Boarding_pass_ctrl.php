...
class Boarding_pass_ctrl extends CI_Controller
{
    ...
    public function create()
    {
        ...
        $data = array(
            ...
            'DocType' => $DocType,
            'DocTypeId' => $DocTypeId,
            'FromDateTime' => $Trip_Start_Date,
            'ToDateTime' => $Trip_End_Date,
            'From_Location' => $Journey_From,
            'To_Location' => $Journey_Upto,
            'Remark' => $Remark,
        ...
        if ($this->db->trans_status() === FALSE) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success text-left">Boarding Pass added successfully</div>');
            redirect('punch');
        }
    }
}
