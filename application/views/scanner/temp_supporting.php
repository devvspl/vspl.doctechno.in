        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box">
                    ...
                    <form id="form1" action="<?= base_url('upload_supporting'); ?>" id="scan_support"
                        name="scan_support" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($main_file)): ?>
                                        <tr>
                                            ...
                                            <td><?= ($main_file->is_main_file == 'Y') ? 'Main File' : 'Support File'; ?>
                                            </td>
                                            <td></td>
                                        </tr>
                                    <?php endif; ?>
                                    ...
                                    foreach ($supporting_files as $supporting_file):
                                        ...
                                        <tr>
                                            ...
                                            <td><?= ($supporting_file->is_main_file == 'Y') ? 'Main File' : 'Support File'; ?>
                                            </td>
                                            <td>
                                                <a href="javascript:void(0);"
                                                    data-support_id="<?= $supporting_file->support_id ?>"
