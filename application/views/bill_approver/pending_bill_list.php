                        ...
                        <div class="table-responsive mailbox-messages">
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(); ?>approve_bill/<?= $row['Scan_Id'] ?>"
                                           class="btn btn-success btn-xs"
                                           onclick="return confirm('Are you sure you want to approve this bill?');">Approve</a>
                                        <a href="javascript:void(0);" class="btn btn-danger btn-xs"
                                           data-id="<?= $row['Scan_Id'] ?>" id="reject_bill">Reject</a>
                                    </td>
...
<script>
    ...
    $(document).on("click", "#reject_bill", function () {
    ...
    $(document).on('click', "#reject_btn", function () {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>reject_bill/' + Scan_Id,
            data: {
