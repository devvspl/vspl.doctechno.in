...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <select name="firm[]" id="firm" class="form-control" multiple="multiple">
        <?php 
        // Ensure $user['firm_id'] is a string, default to empty string if null
...
<div class="form-group">
    ...
    <select name="department[]" id="department" class="form-control" multiple="multiple">
        <?php 
        // Ensure $user['department_id'] is a string, default to empty string if null
        $department_ids = !is_null($user['department_id']) ? $user['department_id'] : '';
        $department_ids_array = explode(',', $department_ids);

        foreach ($departmentlist as $key => $value) { 
        ?>
            <option value="<?= $value['department_id'] ?>" <?php echo in_array($value['department_id'], $department_ids_array) ? 'selected' : ''; ?>>
