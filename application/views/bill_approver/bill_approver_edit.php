      ...
      <div class="row">
         <div class="col-md-3">
            <div class="box">
               ...
               <form id="form1" action="<?= base_url(); ?>bill_approver/update/<?= $id ?>" id="userform" name="userform"
                  ...
                  <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        <input autofocus="" id="first_name" name="first_name" placeholder="" type="text"
                           class="form-control" value="<?php echo set_value('first_name', $user['first_name']); ?>" />
                        <span class="text-danger"><?php echo form_error('first_name'); ?></span>
                     </div>
                     <div class="form-group">
                        <label for="exampleInputEmail1">Last Name</label>
                        <input autofocus="" id="last_name" name="last_name" placeholder="" type="text"
                           class="form-control" value="<?php echo set_value('last_name', $user['last_name']); ?>" />
                     ...
                     <div class="form-group">
                        ...
                        <select name="department[]" id="department" class="form-control" multiple="multiple">
                           ...
                           $department_ids = isset($user['department_id']) && !is_null($user['department_id']) ? $user['department_id'] : '';
                           $department_ids_array = $department_ids ? explode(',', $department_ids) : [];

                           foreach ($departmentlist as $key => $value) {
                              ?>
                              <option value="<?= htmlspecialchars($value['api_id']) ?>"
                                 <?= in_array($value['api_id'], $department_ids_array) ? 'selected' : '' ?>>
                                 <?= htmlspecialchars($value['department_name']) ?>
                              </option>
                              <?php
                           }
                           ?>
                     ...
                     <div class="form-group">
                        ...
                        <input id="username" name="username" placeholder="" type="text" class="form-control"
                              ...
                              foreach ($list as $row) {
                                 ...
                                 <tr>
                                    ...
                                    <td class="mailbox-date pull-right no-print">
                                       <a href="<?= base_url(); ?>bill_approver/edit/<?php echo $row['user_id'] ?>"
