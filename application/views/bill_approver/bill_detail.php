         ...
         <div class="col-md-12">
            <div class="box box-primary">
               ...
               <div class="box-body">
                  <div class="row">
                     <div class="col-md-4">
                        <?php if ($bill_detail->File_Ext == 'pdf') : ?>
                        <object data="<?= $bill_detail->File_Location ?>" type="" height="490px" width="100%;"></object>
                        <?php else : ?>
                        <input type="hidden" name="image" id="image" value="<?= $bill_detail->File_Location ?>">
