      ...
      <div class="row">
         <div class="col-md-3">
            <div class="box box-primary">
               ...
               <form id="form1" action="<?= base_url(); ?>master/BillApproverController/create" id="userform"
                  ...
                  <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" multiple="multiple" id="firm"
                           name="firm[]">
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" multiple="multiple" id="department"
                           name="department[]">
                        </select>
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" multiple="multiple" id="location"
                           name="location[]">
