...
<div class="content-wrapper" style="min-height: 946px;">
   <section class="content">
         ...
         <div class="col-md-12">
            <div class="box">
               ...
               <div class="box-body" id="form_div">
                  <form action="<?= base_url() ?>Search/search_with_filter_status" method="POST" id="search_form" role="form">
                     <div class="row">
                        ...
                        <div class="col-sm-2 col-md-2">
                           <div class="form-group" style="margin-top: 22px;">
							   ...
							   </button> <button type="button" id="reset" name="reset" onclick="reloadPage();" class="btn btn-primary btn-sm checkbox-toggle "><i class="fa fa-refresh"></i> Reset</button>
                           </div>
                        </div>
                     </div>
                  </form>
    ...
    <thead>
        <tr>
            <th colspan="20" id="filter_type" style="text-align: center;">Search Result</th>
        </tr>
        <tr>
            <th>#</th>
            <th style="text-align: center;">Document Name</th>
            <th style="text-align: center;">Temp Scan By</th>
            <th style="text-align: center;">Temp Scan Date</th>
            <th style="text-align: center;">Scan/Naming By</th>
            <th style="text-align: center;">Scan/Naming Date</th>
            <th style="text-align: center;">Bill Approved By</th>
            <th style="text-align: center;">Bill Approved Date</th>
            <th style="text-align: center;">Punch By</th>
            <th style="text-align: center;">Punch Date</th>
			<th style="text-align: center;">Days to Punch</th>
            ...
            <?php $i = 1; foreach ($result as $key => $value): ?>
                <tr>
                    ...
                    <?php else: ?>
                        ...
                        <td style="text-align:center;">-</td>
                    <?php endif; ?>
                    <td style="text-align:left;width:12%"><?= $value['Loc_Name'] ?></td>
                    <td style="text-align:left;width:12%"><?= $value['group_name'] ?></td>
                    <td style="text-align:left;width:12%"><?= $value['FromName'] ?></td>
                    <td style="text-align:left;width:12%"><?= $value['ToName'] ?></td>
                    <td style="text-align:left;width:8%"><?= !empty($value['BillDate']) ? date('d-m-Y', strtotime($value['BillDate'])) : '' ?></td>
                    <td style="text-align:left;width:12%"><?= $value['ServiceNo'] ?></td>
                    <td style="text-align:left;width:8%"><?= !empty($value['BookingDate']) ? date('d-m-Y', strtotime($value['BookingDate'])) : '' ?></td>
                    <td style="text-align:left;"><?= $value['File_No'] ?></td>
                    <td style="text-align:left;">
                        <?= ($value['DocTypeId'] == 23) ? $value['Grand_Total'] : $value['Total_Amount'] ?>
                    </td>
                    <td style="text-align:left;width:8%"><?= date('d-m-Y', strtotime($value['Created_Date'])) ?></td>
                    <td style="text-align:left;width:20%"><?= $value['Remark'] ?></td>
                </tr>
                <?php $i++; endforeach; ?>
        <?php endif; ?>
    </tbody>
...
<script>
   ...
   function reloadPage() {
       window.location.href = "<?php echo base_url(); ?>search_with_filter_status";
   }
</script>
