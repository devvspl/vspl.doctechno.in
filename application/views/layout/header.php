                    ...
                    <li class="treeview <?= set_Topmenu('reports'); ?>">
                        ...
                        <ul class="treeview-menu">
                            <li class="treeview <?= set_Topmenu('report'); ?>">
                                <a href="<?= base_url(); ?>all_report"> <i class="fa fa-file"></i> <span>Report</span> </a>
                            </li>
                            <li class="treeview <?= set_Topmenu('focus_exports'); ?>">
                                <a href="<?= base_url(); ?>focus_exports"> <i class="fa fa-file"></i> <span>Focus Exports</span> </a>
                            </li>
                            <li class="treeview <?= set_Topmenu('reject_list'); ?>">
                                <a href="<?= base_url(); ?>reject_list"> <i class="fa fa-file"></i> <span>Rejected Record</span> </a>
                            </li>
                            <li class="treeview <?= set_Topmenu('bill_approval_report'); ?>">
                                <a href="<?= base_url(); ?>bill_approval_report"> <i class="fa fa-file"></i> <span>Bill Approval Report</span> </a>
                            </li>
                            <li class="treeview <?= set_Topmenu('ledger_wise_report'); ?>">
                                <a href="<?= base_url(); ?>ledger_wise_report"> <i class="fa fa-file"></i> <span>Ledger Wise Report</span> </a>
                            </li>
                            <?php if ($_SESSION['role'] == 'super_scan' || $_SESSION['role'] == 'super_admin') { ?>
                            <li class="treeview <?= set_Topmenu('verification'); ?>">
                                <a href="<?= base_url(); ?>verification"> <i class="fa fa-file"></i> <span>Verification Report</span> </a>
                            </li>
                            <?php } ?>
                        </ul>
                    </li>
