...
<form action="<?= base_url(); ?>Punch/savePunchToDatabase" id="tdsform" name="tdsform" method="post" accept-charset="utf-8">
         ...
         <div class="row">
            ...
            <div class="form-group col-md-3">
               ...
               <input type="text" name="bsr_code" id="bsr_code" class="form-control" value="<?= (isset($punch_detail->bsr_code)) ? $punch_detail->bsr_code : '' ?>">
            </div>
            <div class="form-group col-md-3">
               <label for="challan_no">Challan No:</label>
               <input type="text" name="challan_no" id="challan_no" class="form-control" value="<?= (isset($punch_detail->challan_no)) ? $punch_detail->challan_no : '' ?>">
            </div>
            <div class="form-group col-md-3">
               <label for="challan_date">Challan Date:</label>
               <input type="text" name="challan_date" id="challan_date" class="form-control datepicker" value="<?= (isset($punch_detail->challan_date)) ? date('Y-m-d', strtotime($punch_detail->challan_date)) : '' ?>">
            </div>
         </div>
         <div class="row">
            <div class="form-group col-md-3">
               <label for="bank_reference_no">Bank Reference No:</label>
               <input type="text" name="bank_reference_no" id="bank_reference_no" class="form-control" value="<?= (isset($punch_detail->bank_reference_no)) ? $punch_detail->bank_reference_no : '' ?>">
            </div>
         ...
         <div class="row">
            <div class="form-group col-md-12">
               ...
               <textarea name="remark_comment" id="remark_comment" cols="10" rows="3" class="form-control"><?= (isset($punch_detail->remark_comment)) ? $punch_detail->remark_comment : '' ?></textarea>
            </div>
         </div>
