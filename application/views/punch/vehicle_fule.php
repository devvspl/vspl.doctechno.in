<div id="invoice-details" class="tab-content active">
    <form action="<?= base_url('save_punch_details'); ?>" id="punch_form" name="punch_form" method="post" accept-charset="utf-8">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="number" step="0.01" name="amount" id="amount" readonly class="form-control final_amount_column"
