<div id="invoice-details" class="tab-content active">
   <form action="<?= base_url(); ?>form/InvoiceController/sale_bill_save" id="invoice_form" name="invoice_form"
      method="post" accept-charset="utf-8">
         ...
         <div class="row" style="margin-bottom: 5px;">
            ...
            <div class="form-group col-md-3">
               ...
               <input type="text" name="Supplier_Ref" id="Supplier_Ref" class="form-control form-control-sm"
                  value="<?= (isset($punch_detail->ReferenceNo)) ? $punch_detail->ReferenceNo : '' ?>">
            </div>
         </div>
         <div class="row" style="margin-bottom: 5px;">
         ...
         <div class="row" style="margin-bottom: 5px;">
            <div class="form-group col-md-6">
               ...
               <input type="text" name="Buyer_Address" id="Buyer_Address" class="form-control form-control-sm"
                  value="<?= (isset($punch_detail->Loc_Add)) ? $punch_detail->Loc_Add : '' ?>" readonly>
            </div>
            <div class="col-md-6">
         ...
         <div class="row" style="margin-bottom: 5px;">
            <div class="form-group col-md-3">
               ...
               <input type="text" name="Buyer_Order" id="Buyer_Order" class="form-control form-control-sm"
                  value="<?= (isset($punch_detail->ServiceNo)) ? $punch_detail->ServiceNo : '' ?>">
            </div>
            <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
               ...
               <input type="text" name="Dispatch_Trough" id="Dispatch_Trough"
                  class="form-control form-control-sm"
         ...
         <div class="row" style="margin-bottom: 5px;">
            <div class="form-group col-md-3">
               ...
               <input type="text" name="LR_Number" id="LR_Number" class="form-control form-control-sm"
                  value="<?= (isset($punch_detail->FDRNo)) ? $punch_detail->FDRNo : '' ?>">
            </div>
            <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
               ...
               <input type="text" name="Cartoon_Number" id="Cartoon_Number"
                  class="form-control form-control-sm"
                           ...
                           <select name="Particular[]" id="Particular1"
                              ...
                              <?php
                                 foreach ($item_list as $key => $value) {
                                 	?>
                              <option value="<?= $value['item_name'] ?>"><?= $value['item_name'] ?>
                              </option>
                              <?php } ?>
                           </select>
                        </td>
...
<script>
   $(document).ready(function () {
   			...
   			success: function (response) {
   				...
   				if (response.status == 200) {
   					...
   					for (var i = 1; i <= Count; i++) {
   						...
   						$("#Particular" + i).val(response.data[i - 1].Particular).trigger(
   						'change');
   	...
   	function multi_record(num) {
   		...
   		html += '<td>' + num + '</td>';
   		html += '<td>';
   		html += '<select  name="Particular[]" id="Particular' + num +
   			'" class="form-control form-control-sm particular">' + item_list + '</select>';
   		html += '</td>';
   		html += '<td>';
   ...
   $(document).on('click', "#save_btn", function () {
   	...
   	$.ajax({
   		...
   		success: function (response) {
   			if (response.status == 200) {
   				$(".particular").append('<option value="' + item_name + '">' + item_name +
   					'</option>');
   				$("#item_name").val('');
   				$("#item_code").val('');
   				$("#myModal").modal('hide');
