            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="Party_Name" id="Party_Name" class="form-control"  value="<?= (isset($punch_detail->PartyName)) ? $punch_detail->PartyName : ''  ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" name="Date_of_Confirmation" id="Date_of_Confirmation" class="form-control"  value="<?= (isset($punch_detail->DateOfConfirm)) ? date('Y-m-d',strtotime($punch_detail->DateOfConfirm )) : ''  ?>">
                    </div>
