                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php echo $this->customlib->get_Name($row['finance_punch_action_by']); ?>
                                                </td>

                                                <td class="mailbox-name">
                                                <?php echo !empty($row['finance_punch_action_date']) ? date('d-m-Y', strtotime($row['finance_punch_action_date'])) : ''; ?>
                                                </td>
                                                <td class="mailbox-name">
                                                    <?php echo $row['punch_reject_remark']; ?>
                                                </td>
                                                ...
                                                <td>
                                                        ...
                                                        <a href="<?php echo base_url(); ?>vspl_file_entry/<?= $row['scan_id'] ?>/<?= $row['doc_type_id'] ?>" class="btn btn-danger btn-xs" target="_blank"><i class="fa fa-pencil"></i></a>
