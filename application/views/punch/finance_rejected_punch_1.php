                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                <?php echo !empty($row['finance_punch_action']) ? date('d-m-Y', strtotime($row['finance_punch_action'])) : ''; ?>
                                                </td>
                                                <td class="mailbox-name">
                                                ...
                                                <td>
                                                        ...
                                                        <a href="<?php echo base_url(); ?>vspl_file_entry/<?= $row['Scan_Id'] ?>/<?= $row['DocType_Id'] ?>" class="btn btn-danger btn-xs" target="_blank"><i class="fa fa-pencil"></i></a>
