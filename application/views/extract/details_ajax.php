   ...
   <div class="col-md-6">
      <div class="card">
         <div class="card-body">
            <div class="row">
               <div class="col-12">
                  <p style="margin-top: 5px;"><strong>Company Name:</strong> <?= htmlspecialchars($document->group_name ?? '-'); ?></p>
                  <p style="margin-top: 5px;"><strong>File Name:</strong> <?= htmlspecialchars($document->document_name ?? '-'); ?></p>
                  <p style="margin-top: 5px;"><strong>Scanned By:</strong> <?= htmlspecialchars($document->scanned_by ?? '-'); ?></p>
                  <p style="margin-top: 5px;"><strong>Scan Date:</strong> <?= htmlspecialchars($document->scan_date ?? '-'); ?></p>
               </div>
               <div class="col-md-6">
                  <p style="margin-top: 5px;"><strong>Document Type:</strong></p>
                  <select class="form-control doc-type select2" id="docType_<?= $document->scan_id; ?>" name="doc_type_id">
               ...
               <div class="col-md-6">
                  ...
                  <select class="form-control select2 department" id="department_<?= $document->scan_id; ?>" name="department_id">
               ...
               <div class="col-md-6">
                  <p style="margin-top: 5px;"><strong>Subdepartment:</strong></p>
                  <select class="form-control select2" id="subdepartment_<?= $document->scan_id; ?>" name="sub_department_id">
                     <option value="">Select Subdepartment</option>
                  </select>
               </div>
               <div class="col-md-6">
                  <p style="margin-top: 5px;"><strong>Bill Approver:</strong></p>
                  <select class="form-control select2" id="bill_approver_<?= $document->scan_id; ?>" name="bill_approver_id">
