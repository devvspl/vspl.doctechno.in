            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i class="fa fa-lock"></i> Set Permission -
                            <?= $user['first_name'] . ' ' . $user['last_name']; ?>
                        </h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-sm btn-primary" onclick="savePermissions()">Save
                                Permissions</button>
                        </div>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="tab-content" style="margin-top: 20px;display:block">
                            ...
                            <div class="tab-pane" id="document">
                                <form id="documentForm">
                                    <div class="form-group">
                                        <input type="text" class="form-control" style="width: 300px;"
                                            id="documentSearch" placeholder="Search Documents">
                                    </div>
                            ...
                            <div class="tab-pane" id="location">
                                <form id="locationForm">
                                    <div class="form-group">
                                        <input type="text" class="form-control" style="width: 300px;"
                                            id="locationSearch" placeholder="Search Locations">
                                    </div>
...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            url: '<?= base_url('permissions_data/'); ?>' + userId,
            type: 'GET',
            dataType: 'json',
            success: function (response) {
                ...
                if (response.permissions && response.permissions.length > 0) {
                    ...
                    permissionHtml = `<div class="col-md-12"><p>No permissions available because a primary role is not set. <a href="<?php echo base_url('master/UserController/edit/'); ?>${userId}" target="_blank" class="link mt-2">Set Primary Role</a></p></div>`;
                }
