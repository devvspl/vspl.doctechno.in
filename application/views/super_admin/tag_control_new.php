                            ...
                            <table id="tagControlTable" class="table table-bordered table-striped">
                                <thead>
                                    <tr class="bg-primary text-center">
                                        ...
                                        <th class="text-center" style="text-align: left;">Document Type</th>
                                        <?php
                                        $fields = [
                                            'ledger',
                                            'subledger',
                                        ...
                                        foreach ($fields as $field) {
                                            ...
                                            <th class="text-center" style="text-align: center;">
                                                ...
                                                <div
                                                    style="display: flex;justify-content: center;gap: 3px;margin-top: 5px;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div>
                                                    <button class="btn btn-xs action-btn check-all-btn check-all-row"
                                                        data-document-type-id="<?= $doc['type_id']; ?>" title="Check All">
                                                        <i class="fa fa-check"></i>
                                                    </button>
                                                    <button class="btn btn-xs action-btn uncheck-all-btn uncheck-all-row"
                                                        data-document-type-id="<?= $doc['type_id']; ?>" title="Uncheck All">
                                                        <i class="fa fa-times"></i>
                                                    </button>
                                                </div>
                                            </td>
                                            ...
                                            foreach ($fields as $field) {
                                                ...
                                                foreach ($mappings as $map) {
                                                    if ($map['document_type_id'] == $doc['type_id']) {
                                                ...
                                                <td class="text-center" style="text-align: center;">
                                                    <input type="checkbox" class="mapping-checkbox"
                                                        data-document-type-id="<?= $doc['type_id']; ?>"
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status !== 'success') {
                        ...
                        // alert('Success to update mapping for ' + field);
                    }
                },
                error: function () {
