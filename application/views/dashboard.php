...
$total_bill_approved_by_me_query = $this->db->where('bill_approval_status', 'Y')->where('bill_approver_id',$this->session->userdata('user_id'))->get("y{$year_id}_scan_file")->result_array();
