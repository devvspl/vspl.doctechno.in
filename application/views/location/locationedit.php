        ...
        <div class="row">
            <div class="col-md-3">
                <div class="box">
                    ...
                    <form id="form1" action="<?= base_url(); ?>Location/update/<?= $location_id ?>" id="locationform"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus="" id="location_name" name="location_name" placeholder="" type="text"
                                    class="form-control"
                                    value="<?php echo set_value('location_name', $location['location_name']); ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus="" id="focus_code" name="focus_code" placeholder="" type="text"
                                    class="form-control"
                                    value="<?php echo set_value('focus_code', $location['focus_code']); ?>" />
                ...
                <div class="box" id="exphead">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            <a href="<?= base_url(); ?>location" class="btn btn-primary btn-sm"><i
                                        ...
                                        foreach ($locationlist as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    <a href="<?= base_url(); ?>location/delete/<?php echo $row['location_id'] ?>"
