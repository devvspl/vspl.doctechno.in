...
class Extract_model extends CI_Model
{
    ...
    public function moveDataToPunchfile($scanId, $docTypeId)
    {
        ...
        $punchData = ["scan_id" => $scanId, "doctype" => $docType, "doctype_id" => $docTypeId, "group_id" => $this->session->userdata("group_id"), "created_by" => $this->session->userdata("user_id") ?? 0, "created_at" => date("Y-m-d H:i:s")];
