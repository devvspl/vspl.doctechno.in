...
class Extract_model extends CI_Model {
    ...
    public function getClassificationList($group_id = null, $location_id = null) {
        // Get scan IDs that are in queue
        ...
        // Exclude documents that are in queue
    ...
    private function moveDataToPunchfile($scanId, $docTypeId) {
        ...
        $mappings = $this->db->select("temp_column, input_type, select_table, relation_column, relation_value, punch_column, punch_table, add_condition")
                           ->where(["doctype_id" => $docTypeId, "has_Items_feild" => "N"])
